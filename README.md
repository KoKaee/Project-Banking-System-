...
Système Bancaire Hybride (C) — Projet NF06A
...
L'objectif de ce projet est de développer un système bancaire complet, associant la robustesse et la performance d'un back-end en C (pour la gestion dynamique des structures de données et de la logique métier).
